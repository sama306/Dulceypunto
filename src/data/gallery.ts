...
export const galleryImages: GalleryImage[] = [
  {
    id: 'g-01',
    image: producto01,
    alt: 'Tarta casera de Dulce & Punto — detalle de relleno',
    category: 'Tartas caseras',
  },
  {
    id: 'g-02',
    image: producto02,
    alt: 'Tarta 100% casera de Dulce & Punto — presentación',
    category: 'Tartas caseras',
  },
  {
    id: 'g-03',
    image: producto03,
    alt: 'Tarta casera de Dulce & Punto — vista cercana',
    category: 'Tartas caseras',
  },
  {
    id: 'g-04',
    image: producto04,
    alt: 'Box día del amigo de Dulce & Punto — contenido completo',
    category: 'Box día del amigo',
  },
  {
    id: 'g-05',
    image: producto05,
    alt: 'Box día del amigo de Dulce & Punto — detalle de dulces',
    category: 'Box día del amigo',
  },
  {
    id: 'g-06',
    image: producto06,
    alt: 'Box día del amigo de Dulce & Punto — variedad de productos',
    category: 'Box día del amigo',
  },
  {
    id: 'g-07',
    image: producto07,
    alt: 'Box día del amigo de Dulce & Punto — empaque personalizado',
    category: 'Box día del amigo',
  },
  {
    id: 'g-08',
    image: producto08,
    alt: 'Box día del amigo de Dulce & Punto — presentación final',
    category: 'Box día del amigo',
  },
  {
    id: 'g-09',
    image: producto09,
    alt: 'Cajita para regalar de Dulce & Punto — opción día del amigo',
    category: 'Opciones día del amigo',
  },
  {
    id: 'g-10',
    image: producto10,
    alt: 'Cajita personalizada de Dulce & Punto — día del amigo',
    category: 'Opciones día del amigo',
  },
  {
    id: 'g-12',
    image: producto12,
    alt: 'Box para mates de Dulce & Punto — combo completo',
    category: 'Box para mates',
  },
  {
    id: 'g-13',
    image: producto13,
    alt: 'Combo de dulces caseros de Dulce & Punto — variedad',
    category: 'Combos',
  },
  {
    id: 'g-14',
    image: producto14,
    alt: 'Combo de dulces caseros de Dulce & Punto — presentación',
    category: 'Combos',
  },
  {
    id: 'g-15',
    image: producto15,
    alt: 'Combo de dulces caseros de Dulce & Punto — detalle',
    category: 'Combos',
  },
  {
    id: 'g-16',
    image: producto16,
    alt: 'Combo de dulces caseros de Dulce & Punto — empaque',
    category: 'Combos',
  },
];